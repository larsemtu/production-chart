...
var processData = (data) => {
  return data.map((item) => ({
    ...
    AllocWaterVolM3: Math.ceil(item.AllocWaterVolM3),
    // Assuming this is already a proper number
    ...
    AllocWaterVolTtdM3: Math.ceil(item.AllocWaterVolTtdM3)
    // Assuming this is already a proper number
  }));
};
...
function findAllByType(children, type) {
  ...
  toArray(children).forEach(function(child) {
    var childType = get2(child, "type.displayName") || get2(child, "type.name");
...
var isSvgElement = function isSvgElement2(child) {
  return child && child.type && isString2(child.type) && SVG_TAGS.indexOf(child.type) >= 0;
};
...
var Layer = /* @__PURE__ */ React2.forwardRef(function(props, ref) {
  ...
  var layerClass = clsx2("recharts-layer", className);
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ React3.createElement("path", _extends3({}, filteredProps, {
      className: clsx3("recharts-symbols", className),
  ...
  _createClass(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        var className = clsx4(_defineProperty2(_defineProperty2({
          "recharts-legend-item": true
        }, "legend-item-".concat(i), true), "inactive", entry.inactive));
        if (entry.type === "none") {
          return null;
        }
        var entryValue = !isFunction2(entry.value) ? entry.value : null;
        warn(
          !isFunction2(entry.value),
...
function getUniqPayload(payload, option, defaultUniqBy3) {
  if (option === true) {
    return uniqBy(payload, defaultUniqBy3);
  }
  if (isFunction3(option)) {
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  var hasLabel = !isNil2(label);
  var finalLabel = hasLabel ? label : "";
  var wrapperCN = clsx5("recharts-default-tooltip", wrapperClassName);
  var labelCN = clsx5("recharts-tooltip-label", labelClassName);
...
function getTooltipCSSClassName(_ref) {
  ...
  return clsx6(CSS_CLASS_PREFIX, _defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var ResponsiveContainer = /* @__PURE__ */ forwardRef(function(_ref, ref) {
  ...
  return /* @__PURE__ */ React9.createElement("div", {
    ...
    className: clsx7("recharts-responsive-container", className),
...
var getWordsWithoutCalculate = function getWordsWithoutCalculate2(children) {
  var words = !isNil3(children) ? children.toString().split(BREAKING_SPACES) : [];
  return [{
    words
  }];
};
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ React10.createElement("text", _extends6({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
    className: clsx8("recharts-text", className),
    textAnchor,
    fill: fill.includes("url") ? DEFAULT_FILL : fill
  }), wordsByLines.map(function(line, index) {
    var words = line.words.join(breakAll ? "" : " ");
    return /* @__PURE__ */ React10.createElement("tspan", {
      x: x2,
...
import isFunction6 from "lodash/isFunction";
...
import isFunction5 from "lodash/isFunction";
...
import max2 from "lodash/max";
import min2 from "lodash/min";
import isNil4 from "lodash/isNil";
import isFunction4 from "lodash/isFunction";
import isString3 from "lodash/isString";
import get4 from "lodash/get";
import flatMap from "lodash/flatMap";
import isNan2 from "lodash/isNaN";
import upperFirst2 from "lodash/upperFirst";
...
function calculateStep(min3, max4, tickCount, allowDecimals) {
  ...
  var step = getFormatStep(new decimal_default(max4).sub(min3).div(tickCount - 1), allowDecimals, correctionFactor);
  var middle;
  if (min3 <= 0 && max4 >= 0) {
    middle = new decimal_default(0);
  } else {
    middle = new decimal_default(min3).add(max4).div(2);
...
function getNiceTickValuesFn(_ref3) {
  ...
  return min3 > max4 ? reverse(values2) : values2;
}
...
function getValueByDataKey(obj, dataKey, defaultValue) {
  if (isNil4(obj) || isNil4(dataKey)) {
    return defaultValue;
  }
  if (isNumOrStr(dataKey)) {
    return get4(obj, dataKey, defaultValue);
  }
  if (isFunction4(dataKey)) {
    return dataKey(obj);
  }
  return defaultValue;
}
function getDomainOfDataByKey(data, key, type, filterNil) {
  ...
  if (type === "number") {
    ...
    return domain.length ? [min2(domain), max2(domain)] : [Infinity, -Infinity];
  }
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        result[cateId].push({
          ...
          barSize: isNil4(selfSize) ? globalSize : selfSize
        });
      }
    }
  }
...
var getDomainOfErrorBars = function getDomainOfErrorBars2(data, item, dataKey, layout, axisType) {
  ...
  if (errorBars && errorBars.length) {
    ...
    return data.reduce(function(result, entry) {
      ...
      if (isNil4(entryValue))
        return result;
      var mainValue = Array.isArray(entryValue) ? [min2(entryValue), max2(entryValue)] : [entryValue, entryValue];
...
var offsetSign = function offsetSign2(series) {
  ...
  for (var j = 0, m = series[0].length; j < m; ++j) {
    ...
    var negative = 0;
    for (var i = 0; i < n; ++i) {
      var value = isNan2(series[i][j][1]) ? series[i][j][0] : series[i][j][1];
      if (value >= 0) {
...
var getTicksOfScale = function getTicksOfScale2(scale, opts) {
  ...
  if (tickCount && type === "number" && originalDomain && (originalDomain[0] === "auto" || originalDomain[1] === "auto")) {
    ...
    scale.domain([min2(tickValues), max2(tickValues)]);
    return {
...
function getCateCoordinateOfLine(_ref5) {
  ...
  if (axis.type === "category") {
    if (!axis.allowDuplicatedCategory && axis.dataKey && !isNil4(entry[axis.dataKey])) {
  ...
  var value = getValueByDataKey(entry, !isNil4(dataKey) ? dataKey : axis.dataKey);
  return !isNil4(value) ? axis.scale(value) : null;
}
var getCateCoordinateOfBar = function getCateCoordinateOfBar2(_ref6) {
  ...
  return !isNil4(value) ? axis.scale(value) - bandSize / 2 + offset : null;
};
...
var getDomainOfSingle = function getDomainOfSingle2(data) {
  return data.reduce(function(result, entry) {
    return [min2(entry.concat([result[0]]).filter(isNumber)), max2(entry.concat([result[1]]).filter(isNumber))];
  }, [Infinity, -Infinity]);
};
...
var parseSpecifiedDomain = function parseSpecifiedDomain2(specifiedDomain, dataDomain, allowDataOverflow) {
  if (isFunction4(specifiedDomain)) {
  ...
  } else if (isFunction4(specifiedDomain[0])) {
  ...
  } else if (isFunction4(specifiedDomain[1])) {
...
var getBandSizeOfAxis = function getBandSizeOfAxis2(axis, ticks2, isBar) {
  ...
  if (axis && ticks2 && ticks2.length >= 2) {
    var orderedTicks = sortBy2(ticks2, function(o) {
      return o.coordinate;
    });
...
var parseDomainOfCategoryAxis = function parseDomainOfCategoryAxis2(specifiedDomain, calculatedDomain, axisChild) {
  ...
  if (isEqual(specifiedDomain, get4(axisChild, "type.defaultProps.domain"))) {
    return calculatedDomain;
  }
...
var getLabel = function getLabel2(props) {
  ...
  var label = isNil6(props.children) ? value : props.children;
  if (isFunction6(formatter)) {
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  var id = isNil6(labelProps.id) ? uniqueId("recharts-radial-line-") : labelProps.id;
  return /* @__PURE__ */ React12.createElement("text", _extends8({}, attrs, {
    dominantBaseline: "central",
    className: clsx9("recharts-radial-bar-label", className)
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel2(props) {
  ...
  if (isObject3(position) && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) {
    return _objectSpread12({
...
function Label(_ref4) {
  ...
  if (!viewBox || isNil6(value) && isNil6(children) && !/* @__PURE__ */ isValidElement4(content) && !isFunction6(content)) {
    return null;
  }
  ...
  return /* @__PURE__ */ React12.createElement(Text, _extends8({
    className: clsx9("recharts-label", className)
  }, attrs, positionAttrs, {
...
import isFunction7 from "lodash/isFunction";
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React13.createElement(Layer, {
    ...
    var value = isNil7(dataKey) ? valueAccessor(entry, index) : getValueByDataKey(entry && entry.payload, dataKey);
    var idProps = isNil7(id) ? {} : {
    ...
    return /* @__PURE__ */ React13.createElement(Label, _extends9({}, filterProps(entry, true), others, idProps, {
      ...
      value,
      textBreakAll,
      viewBox: Label.parseViewBox(isNil7(clockWise) ? entry : _objectSpread13(_objectSpread13({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
function parseLabelList(label, data) {
  ...
  if (/* @__PURE__ */ React13.isValidElement(label) || isFunction7(label)) {
    return /* @__PURE__ */ React13.createElement(LabelList, {
      key: "labelList-implicit",
      data,
      content: label
...
var Sector = function Sector2(sectorProps) {
  ...
  var layerClass = clsx10("recharts-sector", className);
...
import upperFirst3 from "lodash/upperFirst";
import isFunction8 from "lodash/isFunction";
...
var getCurveFactory = function getCurveFactory2(type, layout) {
  ...
  var name = "curve".concat(upperFirst3(type));
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ React15.createElement("path", _extends11({}, filterProps(props, false), adaptEventHandlers(props), {
    className: clsx11("recharts-curve", className),
    d: realPath,
    ref: pathRef
  }));
};
...
import React22, { useEffect as useEffect2, useRef as useRef2, useState as useState2 } from "react";
...
import React21, { Children as Children5 } from "react";
...
var TransitionGroupContext_default = React17.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      /* @__PURE__ */ React18.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : React18.cloneElement(React18.Children.only(children), childProps))
    );
  };
  return Transition2;
}(React18.Component);
...
import { Children as Children3, cloneElement as cloneElement5, isValidElement as isValidElement5 } from "react";
function getChildMapping(children, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && isValidElement5(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children)
    Children3.map(children, function(c2) {
      return c2;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children).forEach(function(key) {
    ...
    var isLeaving = isValidElement5(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children[key] = cloneElement5(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && isValidElement5(prevChild)) {
      children[key] = cloneElement5(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React19.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ React19.createElement(Component4, props, children));
  };
...
import React20, { Component, Children as Children4 } from "react";
...
var AnimateGroupChild = /* @__PURE__ */ function(_Component) {
  ...
  _createClass7(AnimateGroupChild2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ React20.createElement(Transition_default, _extends13({}, props, {
        onEnter: this.handleEnter,
        onExit: this.handleExit,
        timeout: this.parseTimeout()
      }), function() {
        return /* @__PURE__ */ React20.createElement(Animate_default, _this2.state, Children4.only(children));
      });
    }
  }]);
...
function AnimateGroup(props) {
  ...
  return /* @__PURE__ */ React21.createElement(TransitionGroup_default, {
    component
  }, Children5.map(children, function(child, index) {
    return /* @__PURE__ */ React21.createElement(AnimateGroupChild_default, {
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  var pathRef = useRef2();
  var _useState = useState2(-1), _useState2 = _slicedToArray9(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  useEffect2(function() {
  ...
  var layerClass = clsx12("recharts-rectangle", className);
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React22.createElement("path", _extends14({}, filterProps(props, true), {
      className: layerClass,
      d: getRectanglePath(x2, y2, width, height, radius)
    }));
  }
  return /* @__PURE__ */ React22.createElement(es6_default, {
    ...
    }, /* @__PURE__ */ React22.createElement("path", _extends14({}, filterProps(props, true), {
      className: layerClass,
...
var Dot = function Dot2(props) {
  ...
  var layerClass = clsx13("recharts-dot", className);
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ React23.createElement("circle", _extends15({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
var Cross = function Cross2(_ref) {
  ...
  return /* @__PURE__ */ React24.createElement("path", _extends16({}, filterProps(props, true), {
    className: clsx14("recharts-cross", className),
    d: getPath3(x2, y2, width, height, top, left)
  }));
};

// node_modules/recharts/es6/util/ActiveShapeUtils.js
import React26, { isValidElement as isValidElement6, cloneElement as cloneElement6 } from "react";
import isFunction9 from "lodash/isFunction";
import isPlainObject from "lodash/isPlainObject";
import isBoolean from "lodash/isBoolean";
import isEqual2 from "lodash/isEqual";

// node_modules/recharts/es6/shape/Trapezoid.js
import React25, { useEffect as useEffect3, useRef as useRef3, useState as useState3 } from "react";
...
var Trapezoid = function Trapezoid2(props) {
  ...
  var pathRef = useRef3();
  var _useState = useState3(-1), _useState2 = _slicedToArray10(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  useEffect3(function() {
    if (pathRef.current && pathRef.current.getTotalLength) {
      try {
        var pathTotalLength = pathRef.current.getTotalLength();
  ...
  var layerClass = clsx15("recharts-trapezoid", className);
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React25.createElement("g", null, /* @__PURE__ */ React25.createElement("path", _extends17({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React25.createElement(es6_default, {
    ...
    return /* @__PURE__ */ React25.createElement(es6_default, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React25.createElement("path", _extends17({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case "rectangle":
      return /* @__PURE__ */ React26.createElement(Rectangle, elementProps);
    case "trapezoid":
      return /* @__PURE__ */ React26.createElement(Trapezoid, elementProps);
    case "sector":
      return /* @__PURE__ */ React26.createElement(Sector, elementProps);
    case "symbols":
      if (isSymbolsProps(shapeType, elementProps)) {
        return /* @__PURE__ */ React26.createElement(Symbols, elementProps);
      }
      break;
    default:
      return null;
...
function getPropsFromShapeOption(option) {
  if (/* @__PURE__ */ isValidElement6(option)) {
    return option.props;
  }
  return option;
}
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ isValidElement6(option)) {
    shape = /* @__PURE__ */ cloneElement6(option, _objectSpread23(_objectSpread23({}, props), getPropsFromShapeOption(option)));
  } else if (isFunction9(option)) {
    shape = option(props);
  } else if (isPlainObject(option) && !isBoolean(option)) {
    var nextProps = propTransformer(option, props);
    shape = /* @__PURE__ */ React26.createElement(ShapeSelector, {
      shapeType,
...
function getActiveShapeIndexForTooltip(_ref3) {
  ...
  var activeItemMatches = itemData.filter(function(datum, dataIndex) {
    var valuesMatch = isEqual2(tooltipPayload, datum);
...
import React27, { PureComponent as PureComponent6, Children as Children6 } from "react";
import clsx16 from "clsx";
import isFunction10 from "lodash/isFunction";
...
var createScale = function createScale2(_ref) {
  ...
  var len = data.length;
  var scale = point3().domain(range4(0, len)).range([x2, x2 + width - travellerWidth]);
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass8(Brush2, [{
    ...
    value: function getTextOfTick(index) {
      ...
      return isFunction10(tickFormatter) ? tickFormatter(text, index) : text;
    }
  }, {
    ...
    value: function renderPanorama() {
      ...
      var chartElement = Children6.only(children);
      if (!chartElement) {
        return null;
      }
      return /* @__PURE__ */ React27.cloneElement(chartElement, {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ React27.createElement(Text, _extends18({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ React27.createElement(Text, _extends18({
        textAnchor: "start",
        verticalAnchor: "middle",
    ...
    value: function render() {
      ...
      var layerClass = clsx16("recharts-brush", className);
      var isPanoramic = React27.Children.count(children) === 1;
    ...
    value: function renderDefaultTraveller(props) {
      ...
      return /* @__PURE__ */ React27.createElement(React27.Fragment, null, /* @__PURE__ */ React27.createElement("rect", {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderTraveller(option, props) {
      ...
      if (/* @__PURE__ */ React27.isValidElement(option)) {
        rectangle = /* @__PURE__ */ React27.cloneElement(option, props);
      } else if (isFunction10(option)) {
...
import isFunction11 from "lodash/isFunction";
...
import React29, { PureComponent as PureComponent7 } from "react";
...
function BarRectangle(props) {
  return /* @__PURE__ */ React28.createElement(Shape, _extends19({
    shapeType: "rectangle",
...
var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
  ...
  return function(value, index) {
    ...
    !isValueNumber ? process.env.NODE_ENV !== "production" ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof31(value), ". Currently only numbers are supported.")) : invariant(false) : void 0;
    return defaultValue;
  };
};
  ...
  _createClass9(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React29.createElement(Layer, _extends20({
        ...
        }), /* @__PURE__ */ React29.createElement(BarRectangle, props));
      });
    }
  }, {
    ...
    value: function renderRectanglesWithAnimation() {
      ...
      return /* @__PURE__ */ React29.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        return /* @__PURE__ */ React29.createElement(Layer, null, _this3.renderRectanglesStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderRectangles() {
      ...
      var prevData = this.state.prevData;
      if (isAnimationActive && data && data.length && (!prevData || !isEqual3(prevData, data))) {
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React29.createElement(BarRectangle, _extends20({
    ...
    value: function renderErrorBar(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ React29.createElement(Layer, errorBarProps, errorBarItems.map(function(item) {
        return /* @__PURE__ */ React29.cloneElement(item, {
    ...
    value: function render() {
      ...
      var layerClass = clsx17("recharts-bar", className);
      var needClipX = xAxis && xAxis.allowDataOverflow;
      var needClipY = yAxis && yAxis.allowDataOverflow;
      var needClip = needClipX || needClipY;
      var clipPathId = isNil8(id) ? this.id : id;
      return /* @__PURE__ */ React29.createElement(Layer, {
        className: layerClass
      }, needClipX || needClipY ? /* @__PURE__ */ React29.createElement("defs", null, /* @__PURE__ */ React29.createElement("clipPath", {
      ...
      }))) : null, /* @__PURE__ */ React29.createElement(Layer, {
...
import React30, { createContext, useContext } from "react";
import find from "lodash/find";
import every2 from "lodash/every";

// node_modules/recharts/es6/util/calculateViewBox.js
import memoize3 from "lodash/memoize";
var calculateViewBox = memoize3(function(offset) {
  return {
    x: offset.left,
    y: offset.top,
    width: offset.width,
...
var ChartLayoutContextProvider = function ChartLayoutContextProvider2(props) {
  ...
  return /* @__PURE__ */ React30.createElement(XAxisContext.Provider, {
    value: xAxisMap
  }, /* @__PURE__ */ React30.createElement(YAxisContext.Provider, {
    value: yAxisMap
  }, /* @__PURE__ */ React30.createElement(OffsetContext.Provider, {
    value: offset
  }, /* @__PURE__ */ React30.createElement(ViewBoxContext.Provider, {
    value: viewBox
  }, /* @__PURE__ */ React30.createElement(ClipPathIdContext.Provider, {
    value: clipPathId
  }, /* @__PURE__ */ React30.createElement(ChartHeightContext.Provider, {
    value: height
  }, /* @__PURE__ */ React30.createElement(ChartWidthContext.Provider, {
    value: width
  }, children)))))));
};
...
var useXAxisOrThrow = function useXAxisOrThrow2(xAxisId) {
  ...
  !(xAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find xAxis by id "'.concat(xAxisId, '" [').concat(_typeof34(xAxisId), "]. ").concat(getKeysForDebug(xAxisMap))) : invariant(false) : void 0;
  return xAxis;
};
var useYAxisOrThrow = function useYAxisOrThrow2(yAxisId) {
  ...
  !(yAxis != null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Could not find yAxis by id "'.concat(yAxisId, '" [').concat(_typeof34(yAxisId), "]. ").concat(getKeysForDebug(yAxisMap))) : invariant(false) : void 0;
  return yAxis;
};
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ React31.isValidElement(option)) {
    line = /* @__PURE__ */ React31.cloneElement(option, props);
  } else if (isFunction11(option)) {
    line = option(props);
  } else {
    line = /* @__PURE__ */ React31.createElement("line", _extends21({}, props, {
...
function ReferenceLine(props) {
  ...
  return /* @__PURE__ */ React31.createElement(Layer, {
    className: clsx18("recharts-reference-line", className)
...
import isFunction12 from "lodash/isFunction";
...
function ReferenceDot(props) {
  ...
  return /* @__PURE__ */ React32.createElement(Layer, {
    className: clsx19("recharts-reference-dot", className)
...
ReferenceDot.renderDot = function(option, props) {
  ...
  if (/* @__PURE__ */ React32.isValidElement(option)) {
    dot = /* @__PURE__ */ React32.cloneElement(option, props);
  } else if (isFunction12(option)) {
    dot = option(props);
  } else {
    dot = /* @__PURE__ */ React32.createElement(Dot, _extends22({}, props, {
      cx: props.cx,
      cy: props.cy,
...
import isFunction13 from "lodash/isFunction";
...
function ReferenceArea(props) {
  ...
  return /* @__PURE__ */ React33.createElement(Layer, {
    className: clsx20("recharts-reference-area", className)
...
ReferenceArea.renderRect = function(option, props) {
  var rect;
  if (/* @__PURE__ */ React33.isValidElement(option)) {
    rect = /* @__PURE__ */ React33.cloneElement(option, props);
  } else if (isFunction13(option)) {
    rect = option(props);
  } else {
    rect = /* @__PURE__ */ React33.createElement(Rectangle, _extends23({}, props, {
...
import React34, { Component as Component2 } from "react";
import isFunction15 from "lodash/isFunction";
import get5 from "lodash/get";
import clsx21 from "clsx";

// node_modules/recharts/es6/cartesian/getTicks.js
import isFunction14 from "lodash/isFunction";
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var getTickSize = function getTickSize2(content, index) {
    var value = isFunction14(tickFormatter) ? tickFormatter(content.value, index) : content.value;
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  ...
  _createClass11(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ React34.createElement("line", _extends24({}, props, {
        className: clsx21("recharts-cartesian-axis-line", get5(axisLine, "className"))
      }));
    }
  }, {
    key: "renderTicks",
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          return /* @__PURE__ */ React34.createElement(Layer, _extends24({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ React34.createElement("line", _extends24({}, tickLineProps, lineCoord, {
            className: clsx21("recharts-cartesian-axis-tick-line", get5(tickLine, "className"))
          })), tick && CartesianAxis2.renderTickItem(tick, tickProps, "".concat(isFunction15(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit2 || "")));
        });
    ...
    value: function render() {
      ...
      if (isFunction15(ticksGenerator)) {
        finalTicks = ticks2 && ticks2.length > 0 ? ticksGenerator(this.props) : ticksGenerator(noTicksProps);
      }
      if (width <= 0 || height <= 0 || !finalTicks || !finalTicks.length) {
        return null;
      }
      return /* @__PURE__ */ React34.createElement(Layer, {
        className: clsx21("recharts-cartesian-axis", className),
    ...
    value: function renderTickItem(option, props, value) {
      var tickItem;
      if (/* @__PURE__ */ React34.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React34.cloneElement(option, props);
      } else if (isFunction15(option)) {
        tickItem = option(props);
      } else {
        tickItem = /* @__PURE__ */ React34.createElement(Text, _extends24({}, props, {
...
import React35, { PureComponent as PureComponent8 } from "react";
import clsx22 from "clsx";
import isFunction16 from "lodash/isFunction";
import max3 from "lodash/max";
import isNil9 from "lodash/isNil";
import isNan3 from "lodash/isNaN";
import isEqual4 from "lodash/isEqual";
var _excluded18 = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"];
var _Area;
...
var Area = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Area2() {
    ...
    _this = _callSuper8(this, Area2, [].concat(args));
    _defineProperty35(_assertThisInitialized11(_this), "state", {
      isAnimationFinished: true
    });
    _defineProperty35(_assertThisInitialized11(_this), "id", uniqueId("recharts-area-"));
    _defineProperty35(_assertThisInitialized11(_this), "handleAnimationEnd", function() {
      var onAnimationEnd2 = _this.props.onAnimationEnd;
      _this.setState({
        isAnimationFinished: true
      });
      if (isFunction16(onAnimationEnd2)) {
        onAnimationEnd2();
      }
    });
    _defineProperty35(_assertThisInitialized11(_this), "handleAnimationStart", function() {
      ...
      if (isFunction16(onAnimationStart2)) {
        onAnimationStart2();
      }
    });
    return _this;
  ...
  _createClass12(Area2, [{
    ...
    value: function renderDots(needClip, clipDot, clipPathId) {
      ...
      return /* @__PURE__ */ React35.createElement(Layer, _extends25({
    ...
    value: function renderHorizontalRect(alpha3) {
      ...
      var maxY = max3(points.map(function(entry) {
        return entry.y || 0;
      }));
      if (isNumber(baseLine) && typeof baseLine === "number") {
        maxY = Math.max(baseLine, maxY);
      } else if (baseLine && Array.isArray(baseLine) && baseLine.length) {
        maxY = Math.max(max3(baseLine.map(function(entry) {
          return entry.y || 0;
        })), maxY);
      }
      if (isNumber(maxY)) {
        return /* @__PURE__ */ React35.createElement("rect", {
    ...
    value: function renderVerticalRect(alpha3) {
      ...
      var maxX = max3(points.map(function(entry) {
        return entry.x || 0;
      }));
      if (isNumber(baseLine) && typeof baseLine === "number") {
        maxX = Math.max(baseLine, maxX);
      } else if (baseLine && Array.isArray(baseLine) && baseLine.length) {
        maxX = Math.max(max3(baseLine.map(function(entry) {
          return entry.x || 0;
        })), maxX);
      }
      if (isNumber(maxX)) {
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      var _this$props4 = this.props, layout = _this$props4.layout, type = _this$props4.type, stroke = _this$props4.stroke, connectNulls = _this$props4.connectNulls, isRange = _this$props4.isRange, ref = _this$props4.ref, others = _objectWithoutProperties17(_this$props4, _excluded18);
      return /* @__PURE__ */ React35.createElement(Layer, {
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, /* @__PURE__ */ React35.createElement(Curve, _extends25({}, filterProps(others, true), {
        points,
        connectNulls,
        type,
        baseLine,
      ...
      })), stroke !== "none" && /* @__PURE__ */ React35.createElement(Curve, _extends25({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points
      })), stroke !== "none" && isRange && /* @__PURE__ */ React35.createElement(Curve, _extends25({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout,
        type,
        connectNulls,
    ...
    value: function renderAreaWithAnimation(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ React35.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        if (prevPoints) {
          ...
          } else if (isNil9(baseLine) || isNan3(baseLine)) {
        ...
        return /* @__PURE__ */ React35.createElement(Layer, null, /* @__PURE__ */ React35.createElement("defs", null, /* @__PURE__ */ React35.createElement("clipPath", {
          id: "animationClipPath-".concat(clipPathId)
        }, _this2.renderClipRect(t))), /* @__PURE__ */ React35.createElement(Layer, {
    ...
    value: function renderArea(needClip, clipPathId) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !isEqual4(prevPoints, points) || !isEqual4(prevBaseLine, baseLine))) {
    ...
    value: function render() {
      ...
      var layerClass = clsx22("recharts-area", className);
      var needClipX = xAxis && xAxis.allowDataOverflow;
      var needClipY = yAxis && yAxis.allowDataOverflow;
      var needClip = needClipX || needClipY;
      var clipPathId = isNil9(id) ? this.id : id;
      ...
      return /* @__PURE__ */ React35.createElement(Layer, {
        className: layerClass
      }, needClipX || needClipY ? /* @__PURE__ */ React35.createElement("defs", null, /* @__PURE__ */ React35.createElement("clipPath", {
        id: "clipPath-".concat(clipPathId)
...
_Area = Area;
_defineProperty35(Area, "displayName", "Area");
_defineProperty35(Area, "defaultProps", {
  stroke: "#3182bd",
  fill: "#3182bd",
  fillOpacity: 0.6,
  xAxisId: 0,
...
_defineProperty35(Area, "getBaseValue", function(props, item, xAxis, yAxis) {
...
_defineProperty35(Area, "getComposedData", function(_ref4) {
...
_defineProperty35(Area, "renderDotItem", function(option, props) {
  var dotItem;
  if (/* @__PURE__ */ React35.isValidElement(option)) {
    dotItem = /* @__PURE__ */ React35.cloneElement(option, props);
  } else if (isFunction16(option)) {
    dotItem = option(props);
  } else {
    var className = clsx22("recharts-area-dot", typeof option !== "boolean" ? option.className : "");
    dotItem = /* @__PURE__ */ React35.createElement(Dot, _extends25({}, props, {
      className
    }));
  }
  return dotItem;
...
var XAxis = function XAxis2(_ref) {
  ...
  return (
    ...
    /* @__PURE__ */ React36.createElement(CartesianAxis, _extends26({}, axisOptions, {
      className: clsx23("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
        width,
...
var YAxis = function YAxis2(_ref) {
  ...
  return (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ React37.createElement(CartesianAxis, _extends27({}, axisOptions, {
      className: clsx24("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
        width,
...
import React38, { Component as Component3, cloneElement as cloneElement8, isValidElement as isValidElement8 } from "react";
import isNil10 from "lodash/isNil";
import isFunction17 from "lodash/isFunction";
...
import { cloneElement as cloneElement7, createElement as createElement2, isValidElement as isValidElement7 } from "react";
...
function Cursor(props) {
  ...
  var cursorProps = _objectSpread35(_objectSpread35(_objectSpread35(_objectSpread35({
    ...
    className: clsx25("recharts-tooltip-cursor", element.props.cursor.className)
  });
  return /* @__PURE__ */ isValidElement7(element.props.cursor) ? /* @__PURE__ */ cloneElement7(element.props.cursor, cursorProps) : /* @__PURE__ */ createElement2(cursorComp, cursorProps);
}
      ...
      if (dataKey) {
        ...
        if (type === "category" && isCategorical) {
          ...
          if (!allowDuplicatedCategory) {
            domain = parseDomainOfCategoryAxis(childDomain, domain, child).reduce(function(finalDomain, entry) {
              return finalDomain.indexOf(entry) >= 0 || entry === "" || isNil10(entry) ? finalDomain : [].concat(_toConsumableArray10(finalDomain), [entry]);
            }, []);
          } else {
            domain = domain.filter(function(entry) {
              return entry !== "" && !isNil10(entry);
            });
          }
        } else if (type === "number") {
  ...
  return graphicalItems.reduce(function(result, child) {
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread36(_objectSpread36({}, result), {}, _defineProperty38({}, axisId, _objectSpread36(_objectSpread36({
        ...
        hide: true,
        orientation: get6(ORIENT_MAP, "".concat(axisType, ".").concat(index % 2), null),
        domain,
        originalDomain,
        isCategorical,
        layout
...
var tooltipTicksGenerator = function tooltipTicksGenerator2(axisMap) {
  ...
  return {
    tooltipTicks,
    orderedTooltipTicks: sortBy3(tooltipTicks, function(o) {
      return o.coordinate;
    }),
    tooltipAxis: axis,
...
var calculateOffset = function calculateOffset2(_ref5, prevLegendBBox) {
  ...
  var offsetV = Object.keys(xAxisMap).reduce(function(result, id) {
    ...
    var orientation = entry.orientation;
    if (!entry.mirror && !entry.hide) {
      return _objectSpread36(_objectSpread36({}, result), {}, _defineProperty38({}, orientation, get6(result, "".concat(orientation)) + entry.height));
    }
    return result;
  }, {
    top: margin.top || 0,
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var getFormatItems = function getFormatItems2(props, currentState) {
    ...
    graphicalItems.forEach(function(item, index) {
      ...
      if (itemIsBar) {
        ...
        var maxBarSize = isNil10(childMaxBarSize) ? globalMaxBarSize : childMaxBarSize;
  ...
  return _CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty38(_assertThisInitialized12(_this), "handleMouseLeave", function(e) {
        ...
        if (isFunction17(onMouseLeave)) {
          onMouseLeave(nextState, e);
        }
      });
      _defineProperty38(_assertThisInitialized12(_this), "handleOuterEvent", function(e) {
        var eventName = getReactEventByType(e);
        var event = get6(_this.props, "".concat(eventName));
        if (eventName && isFunction17(event)) {
          var _mouse;
          var mouse;
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderCursor", function(element) {
        ...
        return /* @__PURE__ */ React38.createElement(Cursor, {
          key,
          activeCoordinate,
          activePayload,
          activeTooltipIndex,
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderPolarAxis", function(element, displayName, index) {
        var axisType = get6(element, "type.axisType");
        var axisMap = get6(_this.state, "".concat(axisType, "Map"));
        var axisOption = axisMap && axisMap[element.props["".concat(axisType, "Id")]];
        return /* @__PURE__ */ cloneElement8(element, _objectSpread36(_objectSpread36({}, axisOption), {}, {
          className: clsx26(axisType, axisOption.className),
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderPolarGrid", function(element) {
        ...
        return /* @__PURE__ */ cloneElement8(element, {
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderLegend", function() {
        ...
        return /* @__PURE__ */ cloneElement8(item, _objectSpread36(_objectSpread36({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderTooltip", function() {
        ...
        return /* @__PURE__ */ cloneElement8(tooltipItem, {
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ cloneElement8(element, _objectSpread36(_objectSpread36({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ cloneElement8(element, _objectSpread36(_objectSpread36(_objectSpread36({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
            if (!isNil10(activePoint)) {
            ...
            return [/* @__PURE__ */ cloneElement8(xyItem, elementProps), null, null];
          }
        }
        if (isRange) {
      ...
      _defineProperty38(_assertThisInitialized12(_this), "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ cloneElement8(element, _objectSpread36(_objectSpread36({
      ...
      _this.throttleTriggeredAfterMouseMove = throttle2(_this.triggeredAfterMouseMove, (_props$throttleDelay = _props.throttleDelay) !== null && _props$throttleDelay !== void 0 ? _props$throttleDelay : 1e3 / 60);
      _this.state = {};
      return _this;
    }
    _createClass14(CategoricalChartWrapper, [{
      ...
      value: function renderClipPath() {
        ...
        return /* @__PURE__ */ React38.createElement("defs", null, /* @__PURE__ */ React38.createElement("clipPath", {
          id: clipPathId
      ...
      value: function render() {
        ...
        var _this$props6 = this.props, children = _this$props6.children, className = _this$props6.className, width = _this$props6.width, height = _this$props6.height, style = _this$props6.style, compact = _this$props6.compact, title = _this$props6.title, desc = _this$props6.desc, others = _objectWithoutProperties18(_this$props6, _excluded25);
        var attrs = filterProps(others, false);
        if (compact) {
          return /* @__PURE__ */ React38.createElement(ChartLayoutContextProvider, {
            state: this.state,
            width: this.props.width,
            height: this.props.height,
            clipPathId: this.clipPathId
          }, /* @__PURE__ */ React38.createElement(Surface, _extends28({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ React38.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ React38.createElement("div", _extends28({
          className: clsx26("recharts-wrapper", className),
  ...
  }(Component3), _defineProperty38(_CategoricalChartWrapper, "displayName", chartName), _defineProperty38(_CategoricalChartWrapper, "defaultProps", _objectSpread36({
    layout: "horizontal",
    stackOffset: "none",
    barCategoryGap: "10%",
    barGap: 4,
    ...
    syncMethod: "index"
  }, defaultProps5)), _defineProperty38(_CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
    ...
    if (!isChildrenEqual(children, prevState.prevChildren)) {
      ...
      var hasGlobalData = !isNil10(data);
    ...
    var dot;
    if (/* @__PURE__ */ isValidElement8(option)) {
      dot = /* @__PURE__ */ cloneElement8(option, props);
    } else if (isFunction17(option)) {
      dot = option(props);
    } else {
      dot = /* @__PURE__ */ React38.createElement(Dot, props);
    }
...
// src/components/CustomProductionChart.tsx
import { useState as useState5 } from "react";

// src/hooks/useDebouncedRange.ts
import { useState as useState4, useEffect as useEffect4 } from "react";
import { debounce } from "lodash";
var useDebouncedRange = (dataLength, delay = 300, desiredTickCount = 10) => {
  const [visibleRange, setVisibleRange] = useState4({
    startIndex: 0,
    endIndex: dataLength - 1
  });
  const [debouncedRange, setDebouncedRange] = useState4(visibleRange);
  const handleBrushChange = (e) => {
    setVisibleRange({ startIndex: e.startIndex, endIndex: e.endIndex });
  };
  useEffect4(() => {
    const updateDebouncedRange = debounce((range6) => {
      setDebouncedRange(range6);
    }, delay);
  ...
  const calculateTickInterval = () => {
    const visibleItemCount = debouncedRange.endIndex - debouncedRange.startIndex + 1;
...
var useDebouncedRange_default = useDebouncedRange;
...
var CustomProductionChart = ({
  ...
  const [visibleSeries, setVisibleSeries] = useState5({
    AllocGasVolSm3: true,
  ...
  const { handleBrushChange, tickInterval } = useDebouncedRange_default(data.length);
  const toggleSeriesVisibility = (dataKey) => {
    setVisibleSeries((prevState) => __spreadProps(__spreadValues({}, prevState), {
      [dataKey]: !prevState[dataKey]
    }));
  };
  return /* @__PURE__ */ jsxs("div", { className: "w-full flex min-h-full flex-col", children: [
    /* @__PURE__ */ jsx2("div", { className: "flex flex-row justify-end space-x-2 pr-10", children: areas.map((area) => /* @__PURE__ */ jsx2(
      Button,
      {
        onClick: () => toggleSeriesVisibility(area.key),
        className: "w-20",
        style: {
          backgroundColor: visibleSeries[area.key] ? area.color : "grey",
          color: "white"
        },
        children: area.name
      },
    ...
    /* @__PURE__ */ jsx2(ResponsiveContainer, { height: 750, width: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data, children: [
      /* @__PURE__ */ jsx2(
        XAxis,
        {
          dataKey: "ProductionDay",
          stroke: "grey",
          tickFormatter: (date2) => new Date(date2).toLocaleDateString("no-NO"),
          height: 50,
          tickCount: 1,
          interval: tickInterval,
          dy: 5,
          children: /* @__PURE__ */ jsx2(Label, { value: "Production Date", position: "insideBottom" })
        }
      ),
      /* @__PURE__ */ jsx2(
        YAxis,
      ...
      /* @__PURE__ */ jsxs("defs", { children: [
        /* @__PURE__ */ jsxs("linearGradient", { id: "colorGas", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsx2("stop", { offset: "5%", stopColor: "red", stopOpacity: 0.8 }),
          /* @__PURE__ */ jsx2("stop", { offset: "95%", stopColor: "red", stopOpacity: 0.1 })
        ] }),
        /* @__PURE__ */ jsxs("linearGradient", { id: "colorOil", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsx2("stop", { offset: "5%", stopColor: "green", stopOpacity: 0.8 }),
          /* @__PURE__ */ jsx2("stop", { offset: "95%", stopColor: "green", stopOpacity: 0.1 })
        ] }),
        /* @__PURE__ */ jsxs("linearGradient", { id: "colorWater", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsx2("stop", { offset: "5%", stopColor: "blue", stopOpacity: 0.8 }),
          /* @__PURE__ */ jsx2("stop", { offset: "95%", stopColor: "blue", stopOpacity: 0.1 })
        ] })
      ] }),
      areas.map(
        (area) => visibleSeries[area.key] && /* @__PURE__ */ jsx2(
          Area,
          {
            type: "monotone",
            dataKey: area.key,
      ...
      /* @__PURE__ */ jsx2(Brush, { onChange: handleBrushChange })
    ] }) })
  ] });
};
...
var ProductionChart = ({ data, cumulative }) => {
  const processedData = processData(data);
  if (cumulative) {
    return /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx3("p", { children: "Version 1.0.10!!" }),
      /* @__PURE__ */ jsx3(CustomProductionChart, { data: processedData, cumulative })
    ] });
  } else {
    return /* @__PURE__ */ jsx3("div", { children: /* @__PURE__ */ jsx3(CustomProductionChart, { data: processedData, cumulative }) });
  }
};
var ProductionChart_default = ProductionChart;

// src/index.tsx
var src_default = ProductionChart_default;
export {
